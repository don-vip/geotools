...
public class FactoryRegistry {
    ...
    private static class SubRegistry {
        ...
        public boolean registerServiceProvider(Object provider) {
            ...
            if (provider instanceof AbstractFactory) {
                ((AbstractFactory)provider).onRegistration(registry, category);
            }
        ...
        public boolean deregisterServiceProvider(Object provider) {
            ...
            if (provider == oprovider) {
                ...
                if (provider instanceof AbstractFactory) {
                    ((AbstractFactory)provider).onDeregistration(registry, category);
                }
        ...
        public boolean setOrdering(Object firstProvider, Object secondProvider) {
            return poset.setOrder(firstProvider, secondProvider);
        }

        public boolean unsetOrdering(Object firstProvider, Object secondProvider) {
            return poset.clearOrder(firstProvider, secondProvider);
        }
     ...
     * that satisfy a criterion imposed by the supplied <code>Filter</code>
     ...
     * @param filter an instance of <code>Filter</code> whose <code>filter</code>
    ...
    public <T> Iterator<T> getServiceProviders(Class<T> category, Filter filter, boolean order) {
        ...
        try {
            Constructor<?> cc = Class.forName("javax.imageio.spi.FilterIterator")
                    .getDeclaredConstructor(Iterator.class, Filter.class);
            AccessController.doPrivileged((PrivilegedAction<Object>) () -> {
                cc.setAccessible(true);
                return null;
            });
            return (Iterator<T>) cc.newInstance(getServiceProviders(category, order), filter);
     ...
     *
     * <p> If <code>provider</code> extends the <code>AbstractFactory</code> class, its
